...
export const Statistics = () => {
  ...
  const { data: totalOrders } = useGetTotalOrdersCountQuery({
    token,
  });
  const { data: completedOrders } = useGetCompletedOrdersCountQuery({
    token,
  });
  const { data: deliveringOrders } = useGetDeliveringOrdersCountQuery({
    token,
  });
  const { data: pendingOrders } = useGetPendingOrdersCountQuery({
    token,
  });

  const { data: totalIncome } = useGetTotalIncomeQuery({
    token,
  });

  const { data: incomeFromFood } = useGetIncomeFromFoodQuery({
    token,
  });

  const { data: incomeFromDeliveries } = useGetIncomeFromDeliveriesQuery({
    token,
  });
  ...
  const { data: totalUsersWhoOrdered } = useGetTotalUsersWhoOrderedQuery({
    token,
  });

  const { data: totalApprovedDrivers } = useGetTotalApprovedDriversQuery({
    token,
  });

  const { data: totalUnApprovedDrivers } = useGetTotalUnApprovedDriversQuery({
    token,
  });

  const { data: totalVerifiedRestaurants } =
    useGetTotalVerifiedRestaurantsQuery({
      token,
    });

  const { data: totalUnVerifiedRestaurants } =
    useGetTotalUnVerifiedRestaurantsQuery({
      token,
    });
                    ...
                    <div className="col-xl-4 col-lg-4 col-8">
                      <div className="line position-relative">
                        ...
                        <h2 className="mb-0 text-primary">
                          RWF {totalIncome?.data || 0}
                        </h2>
                      </div>
                    </div>
                    <div className="col-xl-4 col-lg-4 col-8">
                      <p className="font-w500 text-success mb-2">
                        Income from food
                      </p>
                      <h4 className="cate-title data">
                        RWF {incomeFromFood?.data || 0}
                      </h4>
                    </div>
                    <div className="col-xl-4 col-lg-4 col-8">
                      <p className="font-w500 text-warning mb-2">
                        Income from deliveries
                      </p>
                      <h4 className="cate-title data">
                        RWF {incomeFromDeliveries?.data || 0}
                      </h4>
                    </div>
                  </div>
                </div>
              ...
              <div className="card income style-2">
                <div className="card-body">
                  <div className="d-flex align-itens-center flex-xl-nowrap flex-wrap">
                    <div>
                      <h4 className="cate-title data">Users</h4>
                      <span>
                        {totalUsers?.data || 0} users |{" "}
                        {totalUsersWhoOrdered?.data || 0} ordered
                      </span>
                    </div>
                  </div>
                </div>
            ...
            <div className="col-xl-4 col-lg-4 col-sm-4">
              <div className="card income style-2">
                <div className="card-body">
                  <div className="d-flex align-itens-center flex-xl-nowrap flex-wrap">
                    <div>
                      <h4 className="cate-title data">Drivers</h4>
                      <span>
                        {totalApprovedDrivers?.data || 0} approved |{" "}
                        {totalUnApprovedDrivers?.data || 0} Not Approved
                      </span>
                    </div>
                  </div>
                </div>
            ...
            <div className="col-xl-4 col-lg-4 col-sm-4">
              <div className="card income style-2">
                <div className="card-body">
                  <div className="d-flex align-itens-center flex-xl-nowrap flex-wrap">
                    <div>
                      <h4 className="cate-title data">Restaurants</h4>
                      <span>
                        {totalVerifiedRestaurants?.data || 0} approved |{" "}
                        {totalUnVerifiedRestaurants?.data || 0} Not approved
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className="card">
                <div className="card-body">
                  <div className="d-flex align-items-center mb-4">
                    ...
                    <div>
                      <p className="font-w500 mb-0">Total Orders</p>
                      <h4 className="cate-title mb-0">
                        {totalOrders?.data || 0}
                      </h4>
                    </div>
                  </div>
                  ...
                  <div className="d-flex align-items-center mb-4">
                    ...
                    <div>
                      <p className="font-w500 mb-0">Delivering orders</p>
                      <h4 className="cate-title mb-0">
                        {deliveringOrders?.data || 0}
                      </h4>
                    </div>
                  </div>
                  <div className="d-flex align-items-center mb-0">
                    ...
                    <div>
                      <p className="font-w500 mb-0">Pending orders</p>
                      <h4 className="cate-title mb-0">
