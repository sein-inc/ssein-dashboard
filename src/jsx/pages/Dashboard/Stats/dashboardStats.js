                                    ...
                                    <div className="row">
                                        <div className="col-xl-4 col-lg-4 col-8">
                                            <div className="line position-relative">
                                                ...
                                                <h2 className="mb-0 text-primary">RWF 12,000,00</h2>
                                            </div>
                                        </div>
                                        <div className="col-xl-4 col-lg-4 col-8">
                                            <p className="font-w500 text-success mb-0">Income from food</p>
                                            <h4 className="cate-title data">RWF 8,00,00</h4>
                                        ...
                                        <div className="col-xl-4 col-lg-4 col-8">
                                            <p className="font-w500 text-danger mb-0">Income from deliveries</p>
                                            <h4 className="cate-title data">RWF 4,000,000</h4>
                                            <ul className="d-flex align-items-center">
                                                <li><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="card-body">
                                    <div className="d-flex align-itens-center flex-xl-nowrap flex-wrap">
                                        <div>
                                            ...
                                            <span>700 users | 40 ordered</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="card-body">
                                    <div className="d-flex align-itens-center flex-xl-nowrap flex-wrap">
                                        <div>
                                            ...
                                            <span>30 approved | 4 Not Approved</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="card-body">
                                    <div className="d-flex align-itens-center flex-xl-nowrap flex-wrap">
                                        <div>
                                            ...
                                            <span>10 approved | 20 Not approved</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
