...
import { useApproveRiderMutation } from "../../../../../store/api/apiSlice";
...
export const ViewSingleDriver = () => {
  ...
  const { data: deliveries, isLoading } = useGetDriverDeliveriesQuery({
    token,
    driver_id: driver.id,
  });
  ...
  useEffect(() => {
    if (isApprovalSuccess) {
      setDriver({ ...driver, verified: true });
  ...
  useEffect(() => {
    if (isApprovalError) {
      toast.error("Error approving driver, try again.", {
        position: "top-right",
        autoClose: 3000,
        hideProgressBar: false,
        closeOnClick: true,
    ...
    <>
      <div className="row">
        <div className="col-xl-12">
            ...
            {!driver?.verified ? (
              <div className="d-flex">
                ...
                >
                  {isApprovalLoading ? (
                    <i
                      class="fa-solid fa-spinner fa-spin-pulse fa-2xs"
                      style={{
                        color: "white",
                      }}
                    ></i>
          ...
          <h4 className="cate-title mb-2">Ongoing deliveries</h4>
          <div className="card h-auto deliver-order">
            <div className="card-body">
              ...
              {deliveries?.data?.filter((item) => item.status == "dispatched")
                .length < 1 && (
                ...
                .map((data, i) => (
                  <div className="row mb-2">
                    <div className="col-sm-6  border-right">
                      <div className="mb-md-2">
                        <h4 className="mb-0">
                          Delivery #{data?.id} from Order #{data?.order?.id}
                        </h4>
                        <p className="mb-0">
                          {moment(data?.createdAt).format("D/MM/YYYY HH:mm")}
                        </p>
                      </div>
                      <div>
                        <p className="mb-0">Delivery price</p>
                        <h4 className="font-w600">RWF {data?.delivery_fee}</h4>
                      </div>
                  ...
                  <div className="order-menu">
                    ...
                    <div className="d-flex align-items-center mb-3 justify-content-xl-center justify-content-start">
                      ...
                      <div>
                        <h6 className="font-w600 text-nowrap mb-0">
                          Pepperoni Pizza
                        </h6>
                    ...
                    <div className="col-sm-6">
                      <div className="px- xl-3 px-0 mb-sm-0 mb-3">
                        ...
                        {/* This will be added to show the time the delivery took */}
                    ...
                    <div className="d-flex align-items-center justify-content-between">
                      ...
                      <div className="address-bx mt-3">
                        <span className="d-block mb-2 font-w500">
                          Delivery Address
                        </span>
                        <div className="d-flex align-items-center mb-2">
                          ...
                          <h5 className="mb-0">
                            {data?.delivery_location?.street_address}
                          </h5>
                        </div>
                        <p>
                          {data?.delivery_location?.notes ||
                            data?.delivery_location?.name}
                        </p>
                      </div>
                    </div>
          ...
          <div className="row">
            <div className="col-xl-12">
              <div className="d-flex align-items-center justify-content-between flex-wrap">
                <h4 className="cate-title">Delivery History</h4>
              </div>
              <div className="card h-auto">
                <div className="card-body p-2">
                  <Accordion
                    id="accordion-one"
                    className="style-1 order-accord"
                  >
                      ...
                      .map((data, i) => (
                        <Accordion.Item eventKey={`${i}`}>
                          <Accordion.Header>
                            ...
                            {/* This will be added to show the user who ordered */}
                            {/* <div className="dliver-order-bx d-flex align-items-center">
                            ...
                            <button className={`btn me-5 ${data?.btntheme}`}>
                              {data?.status?.toUpperCase()}
                            </button>
                          </Accordion.Header>
                          {/* This will be added back in the future to view details
                        of an order */}
                              ...
                              <div className="col-xl-3 col-xxl-6 col-sm-6 b-right style-1">
                                <div className="order-menu my-4 dlab-space">
                                  ...
                                  <div className="d-flex align-items-center justify-content-xl-center justify-content-lg-start  mb-2">
                                    ...
                                    <h6 className="text-primary mb-0 ps-3 ms-auto">
                                      +$5.59
                                    </h6>
                                  </div>
